...
const SubscriptionQuestion: React.FC = () => {
  ...
  const handleContinue = () => {
    if (selectedOptions.length > 0) {
      ...
      navigate('/questions/savings-goals'); // Ensure this path is correct
    }
  };
  ...
  return (
    <div className="question-page">
      ...
      <h2><span role="img" aria-label="popcorn">🍿</span> Which of these subscriptions do you have?</h2>
      <ul className="options-list">
        {["Music", "TV Streaming", "Fitness", "Online Courses", "Audio or eBooks", "Meal Delivery", "I don't subscribe to any of these"].map((option) => (
          <li
            key={option}
